...
export default class KhachHang extends Component<Props,State>{
    constructor(props: Props) {
      ...
      componentDidMount(): void {
        const jsonProducts = localStorage.getItem("Khách Hàng");
        if (jsonProducts) {
      ...
      onFinish = () => {
        ...
        Modal.confirm({
          ...
          content: (
            <div>
              ...
              <p><strong>Tên Khách Hàng:</strong> {this.state.name}</p>
        ...
        if (jsonProducts) {
          ...
          localStorage.setItem("Khách Hàng", JSON.stringify(products));
          this.setState({
            dataSource: products,
            showModal: false,
          });
          ...
          localStorage.setItem("Khách Hàng", JSON.stringify([product]));
          this.setState({
            dataSource: [product],
            showModal: false,
          });
 ...
 localStorage.setItem("Khách Hàng", JSON.stringify(products));
  ...
  this.setState({
    ...
    window.location.reload();
      ...
      render(){
        const { searchQuery, dataSource } = this.state;
    ...
    const columns: TableColumnsType<DataType> = [
      {
        ...
        <Modal
          title={this.state.isEdit ? "Cập nhật Khách Hàng" : "Thêm Khách Hàng"}
