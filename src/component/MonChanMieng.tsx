...
export default class MonChanMieng extends Component<Props,State>{
    constructor(props: Props) {
      ...
      componentDidMount(): void {
        const jsonProducts = localStorage.getItem("Món Chán Miệng");
        if (jsonProducts) {
      ...
      onFinish = () => {
        ...
        Modal.confirm({
          ...
          content: (
            <div>
              ...
              <p><strong>Nhà Cung Câp:</strong> {this.state.brand}</p>
        ...
        if (jsonProducts) {
          ...
          localStorage.setItem("Món Chán Miệng", JSON.stringify([product]));
          this.setState({
            dataSource: [product],
            showModal: false,
          });
