...
export default class NuocUong extends Component<Props,State>{
    constructor(props: Props) {
      ...
      componentDidMount(): void {
        const jsonProducts = localStorage.getItem("Nước Uống");
        if (jsonProducts) {
      ...
      onFinish = () => {
        ...
        if (jsonProducts) {
          ...
          localStorage.setItem("Nước Uống", JSON.stringify([product]));
          this.setState({
            dataSource: [product],
            showModal: false,
          });
